...
namespace Common.Net.Func
{
    ...
    /// </summary>
    public class FilterWord2
    {
        public FilterWord2() { }

        public FilterWord2(string dictionaryPath)
        {
        ...
        private void LoadDictionary()
        {
            if (DictionaryPath != string.Empty)
            {
                ...
                foreach (string word in words)
                {
                    ...
                    wordList.Add(key);
                    //Txj  wordList.Add(Microsoft.VisualBasic.Strings.StrConv(key, Microsoft.VisualBasic.VbStrConv.TraditionalChinese, 0));
                }
