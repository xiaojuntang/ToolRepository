...
namespace Common.Net.Security
{
    ...
    public class AesCryptoService : EncryptStrategy
    {
        ...
        public override string Decrypt(string content, string strKey)
        {
            ...
            if (ContainKey)
            {
                content = content.Substring(CRYPTO_KEY_LENGTH * 2);
            }
        ...
        public string Decrypt(string content)
        {
            ...
            if (content.Length <= CRYPTO_KEY_LENGTH * 2)
            {
            ...
            if (ContainKey)
            {
                s_key = content.Substring(0, CRYPTO_KEY_LENGTH * 2);
                content = content.Substring(CRYPTO_KEY_LENGTH * 2);
            }
