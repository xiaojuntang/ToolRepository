...
namespace TestProject.Tasks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    int u = Convert.ToInt32(item);
            //    string reslut = Common.Net.Request.SendRequest.CallPage("http://account.zxxk.com/student/UpdateStudentPassWord?StudentId=" + u + "&PassWord=666666");
            //    if (reslut.ToLower().Equals("false"))
            //    {
            ...
            //var downloader = new Downloader2();
