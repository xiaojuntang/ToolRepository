...
namespace UserServiceClient.Models
{
    ...
    /// 通用返回结果
    /// </summary>
    public partial class ResponseEntityStudent
    {
        /// <summary>
        /// Initializes a new instance of the ResponseEntityStudent class.
        /// </summary>
        ...
        public ResponseEntityStudent(int? code = default(int?), int? bussCode = default(int?), string message = default(string), Student data = default(Student))
        {
            Code = code;
            BussCode = bussCode;
            Message = message;
